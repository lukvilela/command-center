...
//   headers: X-TCC-Secret: <TRYEVO_DASH_SECRET>
//   body: { action, data }
//
// Ações:
...
const SHARED_SECRET = process.env.TRYEVO_DASH_SECRET;
...
exports.handler = async (event) => {
  ...
  if (!SHARED_SECRET) return { statusCode: 500, headers: cors, body: JSON.stringify({ erro: 'TRYEVO_DASH_SECRET não configurado' }) };
